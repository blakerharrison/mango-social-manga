...
class NarutoPage41: MangaPageViewController, UIScrollViewDelegate {

    @IBOutlet weak var scrollView: UIScrollView!
    @IBOutlet weak var imageView: UIImageView!
    
    let currentPage = pageNumber + 40
    
    //MARK: Lifecycle
    override func viewDidLoad() {
        super.viewDidLoad()
        
        loadImage(theUrl: mangaImages(manga: "Naruto", chapter: 109088, page: 41), theImageView: imageView)
