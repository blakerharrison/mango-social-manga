...
class NarutoPage3: MangaPageViewController, UIScrollViewDelegate {
    
     let currentPage = pageNumber + 2
    ...
    override func viewDidLoad() {
        ...
        loadMangaImage(theUrl: mangaImages(manga: "Naruto", chapter: UserDefaults.standard.integer(forKey: "Naruto"), page: 3), theImageView: imageView)
